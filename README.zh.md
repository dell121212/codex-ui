...
<p align="center">
  <img src="./docs/images/dashboard.png" alt="OpenAI Codex 5 小时 / 7 天额度" width="280" />
  &nbsp;
  <img src="./docs/images/grok.png" alt="Grok 官方周额度与月额度" width="280" />
  &nbsp;
  <img src="./docs/images/picker.png" alt="公司折叠选择 · 有用量置顶" width="280" />
</p>

| | |
|---|---|
| **OpenAI** | 5h 环 + 7d 条、本地 Token、模型用量排名 |
| **Grok** | 官方周额度 + 月 credit（`cli-chat-proxy` billing，**不是**上下文窗口） |
| **公司列表** | 折叠切换；已抓到用量的自动置顶 |
